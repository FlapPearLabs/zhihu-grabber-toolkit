...
test('配置、非文本输入和远程/文件引用均在请求前 fail closed', () => {
  ...
  assert.throws(() => buildToolLessResponseRequest({ projection: { ...projection, text: 'read https://example.test' } }), /capability_isolation_unavailable/);
